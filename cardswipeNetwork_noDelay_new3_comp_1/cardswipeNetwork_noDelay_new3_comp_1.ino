...
boolean makeRequest() {
 // Serial.println("requesting");
  ...
  client.print("POST /swipes/new");
  
  String dataString = "app_key=db30ad56947d8521acd0870e765a553077bd6b17";
  dataString+="&user_nnumber=123";
  // client.print("ok");
   delay(100);
   
  for (int k = 2; k < charCount-7; k = k + 1) {
//    client.print(cardData[k]);
//    Serial.print(cardData[k]);
  
  }
    Serial.print("gothere");
 // client.print(F("HELLOCard"));
